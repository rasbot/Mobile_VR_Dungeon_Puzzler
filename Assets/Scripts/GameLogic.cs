...
public class GameLogic : MonoBehaviour
{
    ...
    public GameObject startUI, restartUI, nextLevelUI;
    ...
    public GameObject gameOverAudioHolder;
    public GameObject footstepsAudioHolder;
    public GameObject moaningAudioHolder;
    public GameObject moaning2AudioHolder;
    ...
    { //Reset the puzzle sequence to start the next level
            iTween.MoveTo(player,
                iTween.Hash(
    ...
    { //Do this when the player gets it wrong
        ...
        if (failCount == 1)
        {
            footstepsAudioHolder.GetComponent<GvrAudioSource>().Play();
            //Debug.Log("footsteps audio");
        }
        if (failCount == 2)
        {
            moaningAudioHolder.GetComponent<GvrAudioSource>().Play();
            //Debug.Log("moan audio");
        }
        if (failCount == 3)
        {
            moaning2AudioHolder.GetComponent<GvrAudioSource>().Play();
            //Debug.Log("moan 2 audio");
        }
        if (failCount == 4)
        {
            gameOverAudioHolder.GetComponent<GvrAudioSource>().Play();
